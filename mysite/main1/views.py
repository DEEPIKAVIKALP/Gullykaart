	...
	if request.method == "POST":
	  	...
	  	if form.is_valid() and form_profile.is_valid():
	  		...
	  		return render(request = request,
                          template_name = "main1/register.html",
...
def products(request):
	...
	return render(request = request,
				  template_name = "main1/products.html",
...
def item_details(request,product_id):
		...
		return render(request = request,
					  template_name = "main1/shop-single.html",
...
def product_category(request,slug):
	...
	if slug in categories:
		...
		return render(request = request,
				  template_name = "main1/product_category.html",
...
def checkout(request):
	...
	if request.method == "POST":
	  	...
	  	if form.is_valid():
	  		...
	  		return redirect("main1:checkout")

	  	else:
	 		
			
	  		return render(request = request,
                  template_name = "main1/checkout.html",
...
def placeorder(request, address_id):
	...
	return render(request = request,
                  template_name = "main1/placeorder.html",
...
def thankyou(request, address_id, payment_mode):
	...
	return render(request = request,
                  template_name = "main1/thankyou.html",
...
def order_history(request):
	...
	return render(request = request,
                  template_name = "main1/order_history.html",
...
def profile(request):
	...
	return render(request = request,
                  template_name = "main1/profile.html",
...
def change_profile(request):
	...
	return render(request = request,
                  template_name = "main1/change_profile.html",
...
def change_password(request):
	...
	return render(request = request,
                  template_name = "main1/change_password.html",
...
def forgot_password(request):
	...
	form = ForgotPassword
	return render(request =request,
				  template_name="main1/forgot_password.html",
				  context={"form":form}
				  ) 
...
def cancelorder(request,order_detail_id):
	...
	return redirect("main1:order_history")