# Generated by Django 2.2.2 on 2019-09-29 17:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main1.Category', verbose_name='Category ID')),
                ('supplier_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main1.Supplier', verbose_name='Supplier ID')),
            ],
        ),
        migrations.CreateModel(
            name='Orders',
            fields=[
                ...
                ('billing_address_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main1.Address_details', verbose_name='Address Id')),
                ('shipper_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main1.Shipper', verbose_name='Shipper ID')),
            ],
        ),
        migrations.CreateModel(
            name='OrderDetails',
            fields=[
                ...
                ('email', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Email')),
                ('order_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main1.Orders', verbose_name='Order ID')),
                ('product_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main1.Product', verbose_name='Product ID')),
                ('shipping_address_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main1.Address_details', verbose_name='Address Id')),
            ],
        ),
        migrations.CreateModel(
            name='Cart',
